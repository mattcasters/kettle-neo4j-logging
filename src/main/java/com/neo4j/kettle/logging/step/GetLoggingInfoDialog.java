...
public class GetLoggingInfoDialog extends BaseStepDialog implements StepDialogInterface {
  ...
  public GetLoggingInfoDialog( Shell parent, Object in, TransMeta transMeta, String sname ) {
  ...
  private void ok() {
    ...
    try {
      ...
      new ErrorDialog(
        shell, BaseMessages.getString( PKG, "GetLoggingInfoDialog.ErrorParsingData.DialogTitle" ), BaseMessages
          .getString( PKG, "GetLoggingInfoDialog.ErrorParsingData.DialogMessage" ), e );
    }
    dispose();
  }

  private void getInfo( GetLoggingInfoMeta in ) throws KettleException {
